Just hit enter on the jar to analyse "Location History.json" (must be in the same folder as the jar)
...
-t <int>: Optional (default: 5 years). Number of years in the past to analyse
